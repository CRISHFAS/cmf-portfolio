...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xqayjran', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        toast({
          ...
          description: "Me pondré en contacto contigo en 24 horas.",
          variant: "success",
      ...
      toast({
        ...
        description: "Inténtalo de nuevo o envíame un correo electrónico directamente a cristian.farias.martin@gmail.com",
        variant: "destructive"
      });
    } finally {
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-purple-600">
            Ya sea que esté planeando un proyecto o simplemente quiera conectarse
          </h2>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            Mi bandeja de entrada está a su disposición ante cualquier duda o consulta que tengas.
          </p>
        </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  ...
                  >
                    cristian.farias.martin@gmail.com
                  </a>
                </div>
              </div>
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/cristian-martin-farias",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/CRISHFAS",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  required
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl border border-input bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all text-sm sm:text-base"
                  placeholder="martin-dev@example.com"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder="Hola, me encantaría crear..."
                />
              </div>
