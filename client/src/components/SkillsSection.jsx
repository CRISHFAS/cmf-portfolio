...
const categories = [
  { id: "all", label: "Todas las habilidades", color: "bg-gradient-to-r from-purple-500 to-pink-500" },
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        {filteredSkills.length === 0 && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <p className="text-muted-foreground text-lg">No se encontraron habilidades en esta categoría</p>
          </motion.div>
        )}
      </div>
    </section>
