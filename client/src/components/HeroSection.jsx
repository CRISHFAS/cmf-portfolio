...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container max-w-5xl mx-auto text-center z-10">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Construyo <span className="text-primary font-medium">infraestructuras digitales</span> con un toque de <span className="text-secondary font-medium">innovación</span> y una pizca de deleite.
          </motion.p>
          ...
          >
            ...
            >
              <span className="relative z-10">Explora algunos de mis Trabajos</span>
      ...
      <motion.div 
        className="absolute right-8 top-1/5 hidden lg:flex flex-col gap-4 items-end"
        variants={floatingVariants}
        animate="float"
      >
        {['Express', 'Next.js', 'PostgreSQL', 'Tailwind'].map((tech, i) => (
          <motion.div 
            key={tech}
            className="px-4 py-2 bg-background/80 backdrop-blur-sm border rounded-full text-sm shadow-sm"
            initial={{ x: 20, opacity: 0 }}
